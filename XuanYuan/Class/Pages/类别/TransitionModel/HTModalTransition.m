...
#import "HTModalTransition.h"


@interface HTModalTransition()

@property (nonatomic, assign) HTModalTransitionType type;
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    switch (self.type) {
        case kHTModalTransitionPresent: {
            [self present:transitionContext];
            break;
        }
        case kHTModalTransitionDismiss: {
